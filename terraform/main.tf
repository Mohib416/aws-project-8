...
resource "aws_lb_target_group" "app_tg" {
  ...
  target_type = "ip"   # 🔥 QUESTA RIGA È CRITICA
...
resource "aws_iam_role" "ecs_task_execution_role" {
  name = "ecsTaskExecutionRole-project-8"
...
resource "aws_ecs_task_definition" "app_task" {
  ...
  container_definitions = jsonencode([
    {
      name      = "nginx"
      image     = "257289933091.dkr.ecr.eu-west-1.amazonaws.com/project-8-repo:latest"
      essential = true
